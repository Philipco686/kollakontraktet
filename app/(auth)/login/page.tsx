...
export default function LoginPage() {
  ...
  async function handleMagicLink(e: React.FormEvent) {
    ...
    if (error) {
      setError('Kunde inte skicka inloggningslänk. Kontrollera e-postadressen.')
    } else {
      setSent(true)
    }
    setLoading(false)
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-slate-900">Logga in</h1>
          <p className="mt-2 text-slate-500">Analysera dina avtal på sekunder</p>
        </div>
            ...
            <>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-white px-3 text-slate-400">eller via e-post</span>
                </div>
              </div>
